...
export const DOCS_NAV: DocsNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pricing-usage', title: 'Pricing & usage' },
...
export const DOCS_PAGES: DocsPage[] = [
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'The pitch is simple because the loop is simple. One account. Studio in the browser or Soumtok Desktop on Windows, macOS, and Linux. Models from DeepSeek, Gemini, Claude, Grok, and GPT. Pay with PayPal or M-Pesa from $5 a month. The agent writes against the repos you already keep on GitHub — not a fleet of rented VMs and not a second git company.',
      },
      {
        id: 'what',
        title: 'What it is',
        type: 'p',
        text: 'There are three shells. The dashboard is the workspace around the work: Overview, Models, Settings, Plugins, Connectors, Skills, Keys, Members, Usage, Spending, Billing. Studio is a separate full-screen desk in the browser. Soumtok Desktop is the local IDE with the same account. The landing site explains Studio, models, pricing, and download links. Work happens after you sign in and subscribe or add keys.',
      },
      {
        type: 'p',
      ...
      },
      {
        ...
        items: [
          ...
          'Developers who want the same account in the browser and in Soumtok Desktop',
        ],
      },
      {
        id: 'surfaces',
        ...
        items: [
          ...
          'Soumtok Desktop — Agent-first IDE with terminal, Tab, and the same pools as Studio',
          'Landing — Studio story, models, pricing (Start $5, Pro $20, Pro Plus $48), download links',
      ...
      },
      {
        ...
        items: [
          ...
          'Not only a desktop IDE. Studio in the browser and Soumtok Desktop share one account and one usage meter',
      ...
      },
      {
        ...
        items: [
          ...
          'Subscribe to Start ($5) from Dashboard → Billing, or add your own API keys in Keys',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'You can be in a working Studio chat in a few minutes after subscribing to Start ($5) or adding your own API keys. Paid plans change how much included usage you have, not the first-run steps. The goal is not a tour. The goal is one real prompt against one real repo.',
      },
      {
        id: 'sign-up',
        title: 'Sign up',
      ...
      {
        type: 'callout',
        text: 'Incomplete profiles cannot upload files or use several write features until onboarding is done. You need a username, how you found us, country, and both email and phone codes verified with Soumtok — not just a Google “verified email” badge.',
      },
      {
        id: 'first-chat',
        title: 'First chat',
  ...
  },
  {
    ...
    toc: [
      ...
      { id: 'harness', title: 'Soumtok Agent' },
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'p',
        text: 'A turn is one user message plus whatever Studio streams back: thoughts, file reads, edits, questions, a workbench of files. You stay on the page. If your pool is exhausted you get a 402 with upgrade or BYOK guidance. Paid cycles count usage from the moment you paid.',
      },
      {
        type: 'p',
      ...
      },
      {
        ...
        title: 'Soumtok Agent',
        type: 'p',
        text: 'Soumtok Agent is the harness behind Agent, Ask, and Plan — not a separate model you pick in the catalog. It routes your work through Everyday or Additional models, compresses long threads so you burn fewer tokens on repeat reads, and is included free on every paid plan. You only pay for the model pools your turns use.',
      },
      {
        type: 'ul',
        items: [
          'Agent — multi-step coding: read files, edit, run tools, keep going until the job is done',
          'Ask — quick Q&A without opening a full agent loop',
          'Plan — outline before code moves; good for refactors and new features',
          'Same harness in Studio and Soumtok Desktop — one account, one meter',
        ],
      },
      {
        id: 'model',
      ...
      },
      {
        ...
        type: 'p',
        text: 'Start is three Everyday models on a $5 monthly pool. Pro splits Everyday and Additional models into separate pools. Usage counts from plan start to plan renew. Past included pools: BYOK or on-demand. Spending and Billing are the live meters. Studio itself just sends the turn.',
      },
      {
        id: 'not',
        ...
        type: 'ul',
        items: [
          'Not a replacement for your git host. Attach points at GitHub. Merge happens on GitHub.',
      ...
      },
      {
        ...
        items: [
          ...
          'Read Models for keys, Automations for the jobs you repeat, Billing when your pool runs low.',
        ],
      },
    ],
  },
  {
    ...
    toc: [
      ...
      { id: 'start-vs-pro', title: 'Start vs Pro' },
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Everyday coding on Start — DeepSeek Flash, DeepSeek Pro, or GPT-4.1 Mini',
      ...
      },
      {
        ...
        type: 'p',
        text: 'On a paid plan, Soumtok routes Everyday and Additional models with platform keys — you do not paste vendor secrets for those. Save your own keys in Dashboard → Keys when you want Other models or to keep working after a pool is empty. Ready in the catalog means Soumtok can call that model with your plan or a key you saved. See API keys for BYOK setup.',
      },
      {
        id: 'start-vs-pro',
        title: 'Start vs Pro',
        type: 'p',
        text: 'Start ($5) runs Everyday models only — DeepSeek V4.1 Flash, DeepSeek V4.1 Pro, GPT-4.1 Mini — on one $5 pool. Pro ($20) adds a separate $10 Additional pool for Opus, GPT-6, Sonnet, and Grok. Pools do not mix. You can always use your own keys under Other models.',
      },
      {
        id: 'new',
        title: 'New tag',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Paid accounts connect GitHub; usage counts against your plan pools (see Billing)',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'p',
        text: 'A run burns the same included usage as a Studio turn: your Everyday or Additional pool first, then your own keys (Other models), then on-demand if enabled. A noisy hourly job will fill the bar. Watch Spending. Turn Active off if you are done with the clock.',
      },
      {
        id: 'next',
        title: 'Next steps',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        title: 'Spending',
        type: 'p',
        text: 'Unpaid accounts see Subscribe cards for Start ($5/mo). Paid plans show Current plan (started datetime and expires), Upgrade available, and progress bars for Everyday and Additional pools plus Other models (your keys), on-demand, and a monthly limit. Full rules live on Billing.',
      },
      {
        id: 'other',
        title: 'Other pages',
        ...
        items: [
          ...
          'Plugins — marketplace Add installs the bundle (no MCP hunt); available on all paid plans',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'callout',
        text: 'Add saves the plugin, every skill, and every MCP onto your user row. Studio → + reads those saved skills; Studio → MCP reads the saved servers. Uninstall deletes both. Soumtok does not yet open the vendor login window after Add. Live Notion/Figma/Drive calls start when that OAuth step ships.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        title: 'Plan required',
        type: 'p',
        text: 'Connectors need an active Start, Pro, or Pro Plus plan. Subscribe from Dashboard → Billing if Spending shows Subscribe.',
      },
      {
        id: 'add',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Repo: github.com/trysoumtok/Soumtok',
        ],
      },
      {
        id: 'use',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'p',
        text: 'Studio lists every model in the catalog. Ready means Soumtok can call it with your plan pools or a key you saved. If a model is not ready, add a BYOK key in Dashboard → Keys or upgrade your plan. Included usage draws from Everyday or Additional pools. Your own keys show under Other models on Spending.',
      },
      {
        id: 'image',
        title: 'Image key',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Soumtok is paid-only — there is no free tier. Consumer plans on the landing page are Start ($5 / mo), Pro ($20 / mo), and Pro Plus ($48 / mo). Team ($32 / user / mo) and Team Premium ($96 / user / mo) are available from checkout. Annual is monthly × 12 × 0.8. VAT is 8%. Open Dashboard → Spending to see usage pools, or Dashboard → Billing to change plan and read invoices.',
      },
      {
        id: 'plans',
        title: 'Plans',
        type: 'ul',
        items: [
          'Start — $5 / mo, Everyday models only: DeepSeek V4.1 Flash, DeepSeek V4.1 Pro, GPT-4.1 Mini ($5 Everyday pool)',
          'Pro — $20 / mo, $10 Everyday + $10 Additional pools. Pools do not mix — when Everyday is empty, use Additional models only',
          'Pro Plus — $48 / mo, $24 Everyday + $24 Additional pools (3× Pro capacity)',
          'Team — $32 / user / mo, shared workspace, Pro Plus–class pools per seat',
          'Team Premium — $96 / user / mo, about 5× Team usage',
        ],
      },
      {
        id: 'spend',
        title: 'Spending page',
        type: 'p',
        text: 'Without a plan, Spending shows Subscribe cards pointing to Start ($5). On Start, Pro, and Pro Plus you see Current plan, Upgrade available, then progress bars for Everyday and (on Pro+) Additional pools. BYOK usage appears under Other models. Upgrade opens checkout (M-Pesa or PayPal / card). Adjust Plan opens Billing.',
      },
      {
        id: 'included',
        title: 'Included usage',
        type: 'p',
        text: 'Included usage is work billed to Soumtok platform keys. Start includes one Everyday pool ($5/mo). Pro and Pro Plus split Everyday and Additional models into separate monthly pools — expensive models never draw from the Everyday pool and cheap models never draw from Additional. When a pool is empty, Studio returns 402 for models in that pool until renewal, upgrade, BYOK, or pay-as-you-go. Usage counts from planStartedAt to planRenewsAt.',
      },
      {
        id: 'other',
        title: 'Other models',
      ...
      },
      {
        ...
        title: 'Reset dates',
        type: 'p',
        text: 'On paid plans, the cycle is plan start → plan renew. Overview and Usage can still show raw tokens and calls for a date range you pick. After upgrade, the Spending bars follow the new paid cycle.',
      },
      {
        id: 'pay',
        title: 'How you pay',
        type: 'p',
        text: 'Open Dashboard → Billing or follow Upgrade from Spending. Checkout shows your plan, monthly or yearly (20% off annual), and price in KES or USD. Pay with M-Pesa (STK push to your phone) or PayPal / card. After payment, Spending shows your new pools immediately. Cancel from Billing removes platform models until you subscribe again.',
      },
      {
        id: 'labels',
        title: 'Names we use',
        type: 'p',
        text: 'You will see Start, Pro, Pro Plus, Team, and Team Premium in the product. Without a subscription, Spending shows Subscribe — there is no free tier. For how Studio and Desktop share one meter, how images count, and plan capacity, read Pricing & usage.',
      },
    ],
  },
  {
    ...
    crumb: 'Workspace',
    toc: [
      { id: 'unified', title: 'One account, every surface' },
      { id: 'meter', title: 'How we meter tokens' },
      { id: 'models', title: 'Per-model billing paths' },
      { id: 'images', title: 'Image generation' },
      { id: 'agent', title: 'Soumtok Agent' },
      { id: 'compare', title: 'Why we cost less' },
      { id: 'where', title: 'Where to see usage' },
    ],
    blocks: [
      {
        type: 'p',
        text: 'Soumtok meters like Cursor: one account, separate Everyday and Additional pools on Pro+, every model turn counted in USD against the right pool — whether you work in Studio (browser) or Soumtok Desktop (Electron). Dashboard → Usage is the source of truth. Desktop Settings shows the same plan, pools, and top models pulled from your account.',
      },
      {
        id: 'unified',
        ...
        type: 'ul',
        items: [
          'Studio chat, cloud agents, and Test Hub — every model turn counts against your plan',
          'Soumtok Desktop — agent rounds use the same pools when you are signed in',
          'Images from Studio or Desktop — stills bill from your Everyday pool like coding turns',
          'Voice transcription on Desktop — counts when billed to platform keys',
          'Your own API keys (BYOK) — visible in Usage under Other models; does not drain included pools',
        ],
      },
      {
        type: 'callout',
        text: 'There is no separate Desktop quota. If you burn 20K tokens in Desktop and 10K in Studio today, Spending shows 30K against the same plan pool — exactly how Cursor rolls IDE + cloud into one subscription meter.',
      },
      {
        id: 'meter',
        title: 'How we meter usage',
        type: 'p',
        text: 'Every LLM call logs prompt_tokens + completion_tokens into usage_events. We convert each turn to vendor USD and debit the correct pool: Everyday models (DeepSeek V4.1 Flash, DeepSeek V4.1 Pro, GPT-4.1 Mini) use the Everyday pool; everything else uses the Additional pool on Pro+. Start is $5/mo Everyday only. Pro is $10 Everyday + $10 Additional. Pro Plus is $24 + $24. Pools do not mix. When a pool is empty, switch to models in the other pool (Pro+) or upgrade. BYOK bypasses Soumtok keys — you pay the vendor directly.',
      },
      {
        id: 'models',
        title: 'Per-model billing paths',
        type: 'ul',
        items: [
          'Included — Soumtok platform API keys. Counts toward your plan pool. Same token weight for Flash and Opus: expensive models burn the bar faster because each turn uses more tokens, not because we double-charge per model on included.',
          'BYOK — Your OpenAI / Anthropic / DeepSeek / xAI / OpenRouter key in Dashboard → Keys. Analytics still show the row; invoice is on your provider.',
          'On-demand — After included is gone on platform routing: flat $2/M tokens regardless of model id. Effective cost still rises with Opus vs Flash because output length differs.',
        ],
      },
      {
        type: 'p',
        text: 'Open any model on Dashboard → Models and tap the brief sheet for vendor list price, example turns, and the three billing paths above.',
      },
      {
        id: 'images',
        title: 'Image generation',
        type: 'p',
        text: 'Still images (Flux 2 Max by default, Flux Schnell for faster/cheaper) draw from the same Everyday pool as coding. On Start ($5), expect on the order of dozens of Flux Max images or around a hundred Schnell images per month — exact counts depend on model and prompt size. Usage → Type shows Image rows. Video, music, and TTS are not supported.',
      },
      {
        id: 'agent',
        title: 'Soumtok Agent',
        type: 'p',
        text: 'Soumtok Agent (Agent / Ask / Plan) is free on every plan. It is the harness that runs your session — not a billed model in the picker. Long threads compress tool output and older rounds so you use fewer tokens for the same work. You still pay only for the underlying model pools.',
      },
      {
        type: 'callout',
        text: 'Most daily coding runs on Everyday models inside your included pool. Upgrade to Pro when you need Opus/GPT-6 on a separate Additional pool — same idea as Cursor Pro’s dual caps.',
      },
      {
        id: 'compare',
        title: 'Why we cost less than Cursor, Copilot, and the rest',
        type: 'ul',
        items: [
          'Cursor Pro — $20/mo (US). Soumtok Start — $5/mo; Pro — $20/mo with M-Pesa/PayPal, same agent + GitHub loop, built in Nairobi.',
          'GitHub Copilot — $10–19/mo for completions; agent + multi-model desk is extra. Soumtok is one desk: chat, agent, Test Hub, Desktop.',
          'ChatGPT Plus — $20/mo general chat; no repo-native agent, no PR loop. Soumtok attaches GitHub and ships against your tree.',
          'BYOK option — Keep using keys you already pay for; Soumtok fee is the workspace, not a forced markup on every vendor token.',
          'Africa checkout — KES via M-Pesa (PayHero) plus PayPal; no US-only card requirement.',
        ],
      },
      {
        id: 'where',
        ...
        type: 'ul',
        items: [
          'Dashboard → Usage — date range, chart by model, table with Surface (Studio / Desktop), Type (Included / Image / On-Demand), tokens, and cost. Export CSV.',
          'Dashboard → Spending — pool bars, BYOK vs included, upgrade when a pool is low',
          'Soumtok Desktop → Settings → Usage — same summary as the dashboard',
          'Landing pricing page — example turns, model logos, and image counts per plan',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'ul',
        items: [
          'POST /api/billing/checkout — start checkout for start, pro, pro_plus, team, or team_plus',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Three consumer plans on the landing page: Start $5, Pro $20, Pro Plus $48. There is no free tier — subscribe to Start or bring your own keys. Usage is monthly pools in dollars, not unlimited tokens.',
      },
      {
        id: 'pools',
        title: 'Usage pools',
        type: 'ul',
        items: [
          'Start — one $5 Everyday pool. Models: DeepSeek V4 Flash, DeepSeek V4 Pro, GPT-4.1 Mini',
          'Pro — $10 Everyday + $10 Additional. Pools do not mix',
          'Pro Plus — $24 Everyday + $24 Additional (3× Pro capacity)',
          'Soumtok Agent — free on all plans; only model usage is metered',
          'Images — bill from Everyday pool like coding turns',
        ],
      },
      {
        id: 'spend',
        ...
        type: 'p',
        text: 'Dashboard → Spending is the live view — pool bars on paid plans, Subscribe cards when unpaid. Dashboard → Billing is checkout, monthly vs annual (20% off), and invoices.',
      },
      {
        id: 'landing',
        title: 'Landing vs dashboard',
        type: 'p',
        text: 'The marketing page sells Start, Pro, and Pro Plus with monthly/yearly toggle (20% off annual). Team ($32 / user) and Team Premium ($96 / user) are available from checkout. VAT is 8% where it applies.',
      },
      {
        id: 'upgrade',
        title: 'Upgrade path',
        type: 'ul',
        items: [
          'No plan → Start from Spending or Billing',
          'Start → Pro from Spending Upgrade available',
          'Pro → Pro Plus from the next upgrade card',
          'Cancel → subscribe again to restore platform models',
        ],
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        title: 'The team',
        type: 'p',
        text: 'Changelog notes on the landing page are ships that actually landed. Brand lockup and mark are the files in /images used in the header, sidebar, and public profile. GitHub repo: github.com/trysoumtok/Soumtok.',
      },
      {
        id: 'contact',
        title: 'Contact',
        ...
        items: [
          ...
          'GitHub repo: github.com/trysoumtok/Soumtok',
