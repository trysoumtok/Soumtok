/** Shared helpers for installed plugin skill packs (GitHub playbooks). Desktop CJS — keep in sync with pluginSkillsRuntime.ts */
...
function pluginSkillReadName(skill) {
...
function flattenInstalledPluginSkills(plugins) {
  const out = []
...
function findPluginSkill(pluginSkills, name) {
...
function formatAttachedPluginSkillsBlock(skills, opts = {}) {
